...
var hours
var percentHr
var startDate = new Date('2018/06/26 21:13')
...
app.get('/', function(req, res) {
	...
	console.log('New ip hit: ' + ips);
				...
				+ '<br><br>fees last hr: ' + math.format(feesHr,{exponential:{"lowerExp":-100,"upperExp":100}})
				+ '<br>fees last 24hr: ' + math.format(feesMoreHr ,{exponential:{"lowerExp":-100,"upperExp":100}})
				+ '<br>avg. fees/hr last 24hr: ' + math.format((feesMoreHr / 24),{exponential:{"lowerExp":-100,"upperExp":100}})
			...
			for (var p in arr){
                ...
                try {
					...
					if (orders[i].status == 'open'){
						...
						console.log(math.format(orders[i].fee.cost,{exponential:{"lowerExp":-100,"upperExp":100}}));
