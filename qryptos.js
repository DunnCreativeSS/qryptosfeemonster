...
var hours
var percentHr
var startDate = new Date('2018/06/27 20:22')
...
function doget(req, res){
	if (dorefresh){
		...
		console.log((tracker));
				...
				+ '<br>sold (24 hours) according to trackerdatat in btc: ' + selltot
				+ '<br>total (24 hours) according to trackerdata (who seems to be off) (sats): ' + tot * Math.pow(10,8)
				+ '<br>trackerdata (24 hours):<br><div style="display:none;" id="orders">' + JSON.stringify(orders3) + '</div>'
			...
			for (var p in arr){
                ...
                try {
					...
					for (var i in orders) {
						...
						if (orders[i].symbol == tracker[abc].pair && hours <= 24){
